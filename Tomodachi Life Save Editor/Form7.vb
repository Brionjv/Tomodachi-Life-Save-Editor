Public Class Form7
    ...
    Private Sub Form7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Form1.ComboBox11.Text = "PT" Then
            Label1.Text = "Feito"
            Label1.Location = New Point(183, 268)
            Label8.Text = "Presentes"
            ComboBox3.Items.Item(0) = "(Nenhum)"
            ComboBox3.Items.Item(1) = "Manual de Balé"
            ComboBox3.Items.Item(2) = "Taco de Baseball"
            ComboBox3.Items.Item(3) = "Kit de Beleza"
            ComboBox3.Items.Item(4) = "Livro"
            ComboBox3.Items.Item(5) = "Soprador de Bolhas"
            ComboBox3.Items.Item(6) = "CD"
            ComboBox3.Items.Item(7) = "Celular"
            ComboBox3.Items.Item(8) = "Vara de Pescar"
            ComboBox3.Items.Item(9) = "Taco de Golfe"
            ComboBox3.Items.Item(10) = "Violão"
            ComboBox3.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox3.Items.Item(12) = "Pipa"
            ComboBox3.Items.Item(13) = "Laptop"
            ComboBox3.Items.Item(14) = "Maracas"
            ComboBox3.Items.Item(15) = "Detector de Metal"
            ComboBox3.Items.Item(16) = "Espelho"
            ComboBox3.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox3.Items.Item(18) = "Saco de Pancadas"
            ComboBox3.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox3.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox3.Items.Item(21) = "Balança"
            ComboBox3.Items.Item(22) = "Skate"
            ComboBox3.Items.Item(23) = "Bola de Futebol"
            ComboBox3.Items.Item(24) = "Kit de Estudos"
            ComboBox3.Items.Item(25) = "Raquete de Tênis"
            ComboBox3.Items.Item(26) = "Esteira"
            ComboBox3.Items.Item(27) = "Wii U"
            ComboBox3.Items.Item(28) = "Manual de Yoga"
            ComboBox4.Items.Item(0) = "(Nenhum)"
            ComboBox4.Items.Item(1) = "Manual de Balé"
            ComboBox4.Items.Item(2) = "Taco de Baseball"
            ComboBox4.Items.Item(3) = "Kit de Beleza"
            ComboBox4.Items.Item(4) = "Livro"
            ComboBox4.Items.Item(5) = "Soprador de Bolhas"
            ComboBox4.Items.Item(6) = "CD"
            ComboBox4.Items.Item(7) = "Celular"
            ComboBox4.Items.Item(8) = "Vara de Pescar"
            ComboBox4.Items.Item(9) = "Taco de Golfe"
            ComboBox4.Items.Item(10) = "Violão"
            ComboBox4.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox4.Items.Item(12) = "Pipa"
            ComboBox4.Items.Item(13) = "Laptop"
            ComboBox4.Items.Item(14) = "Maracas"
            ComboBox4.Items.Item(15) = "Detector de Metal"
            ComboBox4.Items.Item(16) = "Espelho"
            ComboBox4.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox4.Items.Item(18) = "Saco de Pancadas"
            ComboBox4.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox4.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox4.Items.Item(21) = "Balança"
            ComboBox4.Items.Item(22) = "Skate"
            ComboBox4.Items.Item(23) = "Bola de Futebol"
            ComboBox4.Items.Item(24) = "Kit de Estudos"
            ComboBox4.Items.Item(25) = "Raquete de Tênis"
            ComboBox4.Items.Item(26) = "Esteira"
            ComboBox4.Items.Item(27) = "Wii U"
            ComboBox4.Items.Item(28) = "Manual de Yoga"
            ComboBox5.Items.Item(0) = "(Nenhum)"
            ComboBox5.Items.Item(1) = "Manual de Balé"
            ComboBox5.Items.Item(2) = "Taco de Baseball"
            ComboBox5.Items.Item(3) = "Kit de Beleza"
            ComboBox5.Items.Item(4) = "Livro"
            ComboBox5.Items.Item(5) = "Soprador de Bolhas"
            ComboBox5.Items.Item(6) = "CD"
            ComboBox5.Items.Item(7) = "Celular"
            ComboBox5.Items.Item(8) = "Vara de Pescar"
            ComboBox5.Items.Item(9) = "Taco de Golfe"
            ComboBox5.Items.Item(10) = "Violão"
            ComboBox5.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox5.Items.Item(12) = "Pipa"
            ComboBox5.Items.Item(13) = "Laptop"
            ComboBox5.Items.Item(14) = "Maracas"
            ComboBox5.Items.Item(15) = "Detector de Metal"
            ComboBox5.Items.Item(16) = "Espelho"
            ComboBox5.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox5.Items.Item(18) = "Saco de Pancadas"
            ComboBox5.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox5.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox5.Items.Item(21) = "Balança"
            ComboBox5.Items.Item(22) = "Skate"
            ComboBox5.Items.Item(23) = "Bola de Futebol"
            ComboBox5.Items.Item(24) = "Kit de Estudos"
            ComboBox5.Items.Item(25) = "Raquete de Tênis"
            ComboBox5.Items.Item(26) = "Esteira"
            ComboBox5.Items.Item(27) = "Wii U"
            ComboBox5.Items.Item(28) = "Manual de Yoga"
            ComboBox6.Items.Item(0) = "(Nenhum)"
            ComboBox6.Items.Item(1) = "Manual de Balé"
            ComboBox6.Items.Item(2) = "Taco de Baseball"
            ComboBox6.Items.Item(3) = "Kit de Beleza"
            ComboBox6.Items.Item(4) = "Livro"
            ComboBox6.Items.Item(5) = "Soprador de Bolhas"
            ComboBox6.Items.Item(6) = "CD"
            ComboBox6.Items.Item(7) = "Celular"
            ComboBox6.Items.Item(8) = "Vara de Pescar"
            ComboBox6.Items.Item(9) = "Taco de Golfe"
            ComboBox6.Items.Item(10) = "Violão"
            ComboBox6.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox6.Items.Item(12) = "Pipa"
            ComboBox6.Items.Item(13) = "Laptop"
            ComboBox6.Items.Item(14) = "Maracas"
            ComboBox6.Items.Item(15) = "Detector de Metal"
            ComboBox6.Items.Item(16) = "Espelho"
            ComboBox6.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox6.Items.Item(18) = "Saco de Pancadas"
            ComboBox6.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox6.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox6.Items.Item(21) = "Balança"
            ComboBox6.Items.Item(22) = "Skate"
            ComboBox6.Items.Item(23) = "Bola de Futebol"
            ComboBox6.Items.Item(24) = "Kit de Estudos"
            ComboBox6.Items.Item(25) = "Raquete de Tênis"
            ComboBox6.Items.Item(26) = "Esteira"
            ComboBox6.Items.Item(27) = "Wii U"
            ComboBox6.Items.Item(28) = "Manual de Yoga"
            ComboBox7.Items.Item(0) = "(Nenhum)"
            ComboBox7.Items.Item(1) = "Manual de Balé"
            ComboBox7.Items.Item(2) = "Taco de Baseball"
            ComboBox7.Items.Item(3) = "Kit de Beleza"
            ComboBox7.Items.Item(4) = "Livro"
            ComboBox7.Items.Item(5) = "Soprador de Bolhas"
            ComboBox7.Items.Item(6) = "CD"
            ComboBox7.Items.Item(7) = "Celular"
            ComboBox7.Items.Item(8) = "Vara de Pescar"
            ComboBox7.Items.Item(9) = "Taco de Golfe"
            ComboBox7.Items.Item(10) = "Violão"
            ComboBox7.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox7.Items.Item(12) = "Pipa"
            ComboBox7.Items.Item(13) = "Laptop"
            ComboBox7.Items.Item(14) = "Maracas"
            ComboBox7.Items.Item(15) = "Detector de Metal"
            ComboBox7.Items.Item(16) = "Espelho"
            ComboBox7.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox7.Items.Item(18) = "Saco de Pancadas"
            ComboBox7.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox7.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox7.Items.Item(21) = "Balança"
            ComboBox7.Items.Item(22) = "Skate"
            ComboBox7.Items.Item(23) = "Bola de Futebol"
            ComboBox7.Items.Item(24) = "Kit de Estudos"
            ComboBox7.Items.Item(25) = "Raquete de Tênis"
            ComboBox7.Items.Item(26) = "Esteira"
            ComboBox7.Items.Item(27) = "Wii U"
            ComboBox7.Items.Item(28) = "Manual de Yoga"
            ComboBox8.Items.Item(0) = "(Nenhum)"
            ComboBox8.Items.Item(1) = "Manual de Balé"
            ComboBox8.Items.Item(2) = "Taco de Baseball"
            ComboBox8.Items.Item(3) = "Kit de Beleza"
            ComboBox8.Items.Item(4) = "Livro"
            ComboBox8.Items.Item(5) = "Soprador de Bolhas"
            ComboBox8.Items.Item(6) = "CD"
            ComboBox8.Items.Item(7) = "Celular"
            ComboBox8.Items.Item(8) = "Vara de Pescar"
            ComboBox8.Items.Item(9) = "Taco de Golfe"
            ComboBox8.Items.Item(10) = "Violão"
            ComboBox8.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox8.Items.Item(12) = "Pipa"
            ComboBox8.Items.Item(13) = "Laptop"
            ComboBox8.Items.Item(14) = "Maracas"
            ComboBox8.Items.Item(15) = "Detector de Metal"
            ComboBox8.Items.Item(16) = "Espelho"
            ComboBox8.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox8.Items.Item(18) = "Saco de Pancadas"
            ComboBox8.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox8.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox8.Items.Item(21) = "Balança"
            ComboBox8.Items.Item(22) = "Skate"
            ComboBox8.Items.Item(23) = "Bola de Futebol"
            ComboBox8.Items.Item(24) = "Kit de Estudos"
            ComboBox8.Items.Item(25) = "Raquete de Tênis"
            ComboBox8.Items.Item(26) = "Esteira"
            ComboBox8.Items.Item(27) = "Wii U"
            ComboBox8.Items.Item(28) = "Manual de Yoga"
            ComboBox9.Items.Item(0) = "(Nenhum)"
            ComboBox9.Items.Item(1) = "Manual de Balé"
            ComboBox9.Items.Item(2) = "Taco de Baseball"
            ComboBox9.Items.Item(3) = "Kit de Beleza"
            ComboBox9.Items.Item(4) = "Livro"
            ComboBox9.Items.Item(5) = "Soprador de Bolhas"
            ComboBox9.Items.Item(6) = "CD"
            ComboBox9.Items.Item(7) = "Celular"
            ComboBox9.Items.Item(8) = "Vara de Pescar"
            ComboBox9.Items.Item(9) = "Taco de Golfe"
            ComboBox9.Items.Item(10) = "Violão"
            ComboBox9.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox9.Items.Item(12) = "Pipa"
            ComboBox9.Items.Item(13) = "Laptop"
            ComboBox9.Items.Item(14) = "Maracas"
            ComboBox9.Items.Item(15) = "Detector de Metal"
            ComboBox9.Items.Item(16) = "Espelho"
            ComboBox9.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox9.Items.Item(18) = "Saco de Pancadas"
            ComboBox9.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox9.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox9.Items.Item(21) = "Balança"
            ComboBox9.Items.Item(22) = "Skate"
            ComboBox9.Items.Item(23) = "Bola de Futebol"
            ComboBox9.Items.Item(24) = "Kit de Estudos"
            ComboBox9.Items.Item(25) = "Raquete de Tênis"
            ComboBox9.Items.Item(26) = "Esteira"
            ComboBox9.Items.Item(27) = "Wii U"
            ComboBox9.Items.Item(28) = "Manual de Yoga"
            ComboBox10.Items.Item(0) = "(Nenhum)"
            ComboBox10.Items.Item(1) = "Manual de Balé"
            ComboBox10.Items.Item(2) = "Taco de Baseball"
            ComboBox10.Items.Item(3) = "Kit de Beleza"
            ComboBox10.Items.Item(4) = "Livro"
            ComboBox10.Items.Item(5) = "Soprador de Bolhas"
            ComboBox10.Items.Item(6) = "CD"
            ComboBox10.Items.Item(7) = "Celular"
            ComboBox10.Items.Item(8) = "Vara de Pescar"
            ComboBox10.Items.Item(9) = "Taco de Golfe"
            ComboBox10.Items.Item(10) = "Violão"
            ComboBox10.Items.Item(11) = "Manual de dança Hula-Hula"
            ComboBox10.Items.Item(12) = "Pipa"
            ComboBox10.Items.Item(13) = "Laptop"
            ComboBox10.Items.Item(14) = "Maracas"
            ComboBox10.Items.Item(15) = "Detector de Metal"
            ComboBox10.Items.Item(16) = "Espelho"
            ComboBox10.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox10.Items.Item(18) = "Saco de Pancadas"
            ComboBox10.Items.Item(19) = "Cupom para alugar um gato"
            ComboBox10.Items.Item(20) = "Cupom para alugar um cachorro"
            ComboBox10.Items.Item(21) = "Balança"
            ComboBox10.Items.Item(22) = "Skate"
            ComboBox10.Items.Item(23) = "Bola de Futebol"
            ComboBox10.Items.Item(24) = "Kit de Estudos"
            ComboBox10.Items.Item(25) = "Raquete de Tênis"
            ComboBox10.Items.Item(26) = "Esteira"
            ComboBox10.Items.Item(27) = "Wii U"
            ComboBox10.Items.Item(28) = "Manual de Yoga"
        End If
        If Form1.ComboBox11.Text = "ES" Then
            Label1.Text = "Guardar"
            Label1.Location = New Point(175, 268)
            Label8.Text = "Objetos"
            ComboBox3.Items.Item(0) = "(No)"
            ComboBox3.Items.Item(1) = "Manual de ballet"
            ComboBox3.Items.Item(2) = "Bate de béisbol"
            ComboBox3.Items.Item(3) = "Kit de belleza"
            ComboBox3.Items.Item(4) = "Libro"
            ComboBox3.Items.Item(5) = "Pompas de jabón"
            ComboBox3.Items.Item(6) = "CD"
            ComboBox3.Items.Item(7) = "Teléfono móvil"
            ComboBox3.Items.Item(8) = "Caña de pescar"
            ComboBox3.Items.Item(9) = "Palo de golf"
            ComboBox3.Items.Item(10) = "Guitarra"
            ComboBox3.Items.Item(11) = "Manual de danza hula"
            ComboBox3.Items.Item(12) = "Cometa"
            ComboBox3.Items.Item(13) = "Ordenador portátil"
            ComboBox3.Items.Item(14) = "Maracas"
            ComboBox3.Items.Item(15) = "Detector de metales"
            ComboBox3.Items.Item(16) = "Espejo"
            ComboBox3.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox3.Items.Item(18) = "Saco de boxeo"
            ComboBox3.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox3.Items.Item(20) = "Vale para cuidar perros"
            ComboBox3.Items.Item(21) = "Báscula"
            ComboBox3.Items.Item(22) = "Monopatín"
            ComboBox3.Items.Item(23) = "Balón de fútbol"
            ComboBox3.Items.Item(24) = "Kit de estudio"
            ComboBox3.Items.Item(25) = "Raqueta de tenis"
            ComboBox3.Items.Item(26) = "Cinta de correr"
            ComboBox3.Items.Item(27) = "Wii U"
            ComboBox3.Items.Item(28) = "Manual de yoga"
            ComboBox4.Items.Item(0) = "(No)"
            ComboBox4.Items.Item(1) = "Manual de ballet"
            ComboBox4.Items.Item(2) = "Bate de béisbol"
            ComboBox4.Items.Item(3) = "Kit de belleza"
            ComboBox4.Items.Item(4) = "Libro"
            ComboBox4.Items.Item(5) = "Pompas de jabón"
            ComboBox4.Items.Item(6) = "CD"
            ComboBox4.Items.Item(7) = "Teléfono móvil"
            ComboBox4.Items.Item(8) = "Caña de pescar"
            ComboBox4.Items.Item(9) = "Palo de golf"
            ComboBox4.Items.Item(10) = "Guitarra"
            ComboBox4.Items.Item(11) = "Manual de danza hula"
            ComboBox4.Items.Item(12) = "Cometa"
            ComboBox4.Items.Item(13) = "Ordenador portátil"
            ComboBox4.Items.Item(14) = "Maracas"
            ComboBox4.Items.Item(15) = "Detector de metales"
            ComboBox4.Items.Item(16) = "Espejo"
            ComboBox4.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox4.Items.Item(18) = "Saco de boxeo"
            ComboBox4.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox4.Items.Item(20) = "Vale para cuidar perros"
            ComboBox4.Items.Item(21) = "Báscula"
            ComboBox4.Items.Item(22) = "Monopatín"
            ComboBox4.Items.Item(23) = "Balón de fútbol"
            ComboBox4.Items.Item(24) = "Kit de estudio"
            ComboBox4.Items.Item(25) = "Raqueta de tenis"
            ComboBox4.Items.Item(26) = "Cinta de correr"
            ComboBox4.Items.Item(27) = "Wii U"
            ComboBox4.Items.Item(28) = "Manual de yoga"
            ComboBox5.Items.Item(0) = "(No)"
            ComboBox5.Items.Item(1) = "Manual de ballet"
            ComboBox5.Items.Item(2) = "Bate de béisbol"
            ComboBox5.Items.Item(3) = "Kit de belleza"
            ComboBox5.Items.Item(4) = "Libro"
            ComboBox5.Items.Item(5) = "Pompas de jabón"
            ComboBox5.Items.Item(6) = "CD"
            ComboBox5.Items.Item(7) = "Teléfono móvil"
            ComboBox5.Items.Item(8) = "Caña de pescar"
            ComboBox5.Items.Item(9) = "Palo de golf"
            ComboBox5.Items.Item(10) = "Guitarra"
            ComboBox5.Items.Item(11) = "Manual de danza hula"
            ComboBox5.Items.Item(12) = "Cometa"
            ComboBox5.Items.Item(13) = "Ordenador portátil"
            ComboBox5.Items.Item(14) = "Maracas"
            ComboBox5.Items.Item(15) = "Detector de metales"
            ComboBox5.Items.Item(16) = "Espejo"
            ComboBox5.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox5.Items.Item(18) = "Saco de boxeo"
            ComboBox5.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox5.Items.Item(20) = "Vale para cuidar perros"
            ComboBox5.Items.Item(21) = "Báscula"
            ComboBox5.Items.Item(22) = "Monopatín"
            ComboBox5.Items.Item(23) = "Balón de fútbol"
            ComboBox5.Items.Item(24) = "Kit de estudio"
            ComboBox5.Items.Item(25) = "Raqueta de tenis"
            ComboBox5.Items.Item(26) = "Cinta de correr"
            ComboBox5.Items.Item(27) = "Wii U"
            ComboBox5.Items.Item(28) = "Manual de yoga"
            ComboBox6.Items.Item(0) = "(No)"
            ComboBox6.Items.Item(1) = "Manual de ballet"
            ComboBox6.Items.Item(2) = "Bate de béisbol"
            ComboBox6.Items.Item(3) = "Kit de belleza"
            ComboBox6.Items.Item(4) = "Libro"
            ComboBox6.Items.Item(5) = "Pompas de jabón"
            ComboBox6.Items.Item(6) = "CD"
            ComboBox6.Items.Item(7) = "Teléfono móvil"
            ComboBox6.Items.Item(8) = "Caña de pescar"
            ComboBox6.Items.Item(9) = "Palo de golf"
            ComboBox6.Items.Item(10) = "Guitarra"
            ComboBox6.Items.Item(11) = "Manual de danza hula"
            ComboBox6.Items.Item(12) = "Cometa"
            ComboBox6.Items.Item(13) = "Ordenador portátil"
            ComboBox6.Items.Item(14) = "Maracas"
            ComboBox6.Items.Item(15) = "Detector de metales"
            ComboBox6.Items.Item(16) = "Espejo"
            ComboBox6.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox6.Items.Item(18) = "Saco de boxeo"
            ComboBox6.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox6.Items.Item(20) = "Vale para cuidar perros"
            ComboBox6.Items.Item(21) = "Báscula"
            ComboBox6.Items.Item(22) = "Monopatín"
            ComboBox6.Items.Item(23) = "Balón de fútbol"
            ComboBox6.Items.Item(24) = "Kit de estudio"
            ComboBox6.Items.Item(25) = "Raqueta de tenis"
            ComboBox6.Items.Item(26) = "Cinta de correr"
            ComboBox6.Items.Item(27) = "Wii U"
            ComboBox6.Items.Item(28) = "Manual de yoga"
            ComboBox7.Items.Item(0) = "(No)"
            ComboBox7.Items.Item(1) = "Manual de ballet"
            ComboBox7.Items.Item(2) = "Bate de béisbol"
            ComboBox7.Items.Item(3) = "Kit de belleza"
            ComboBox7.Items.Item(4) = "Libro"
            ComboBox7.Items.Item(5) = "Pompas de jabón"
            ComboBox7.Items.Item(6) = "CD"
            ComboBox7.Items.Item(7) = "Teléfono móvil"
            ComboBox7.Items.Item(8) = "Caña de pescar"
            ComboBox7.Items.Item(9) = "Palo de golf"
            ComboBox7.Items.Item(10) = "Guitarra"
            ComboBox7.Items.Item(11) = "Manual de danza hula"
            ComboBox7.Items.Item(12) = "Cometa"
            ComboBox7.Items.Item(13) = "Ordenador portátil"
            ComboBox7.Items.Item(14) = "Maracas"
            ComboBox7.Items.Item(15) = "Detector de metales"
            ComboBox7.Items.Item(16) = "Espejo"
            ComboBox7.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox7.Items.Item(18) = "Saco de boxeo"
            ComboBox7.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox7.Items.Item(20) = "Vale para cuidar perros"
            ComboBox7.Items.Item(21) = "Báscula"
            ComboBox7.Items.Item(22) = "Monopatín"
            ComboBox7.Items.Item(23) = "Balón de fútbol"
            ComboBox7.Items.Item(24) = "Kit de estudio"
            ComboBox7.Items.Item(25) = "Raqueta de tenis"
            ComboBox7.Items.Item(26) = "Cinta de correr"
            ComboBox7.Items.Item(27) = "Wii U"
            ComboBox7.Items.Item(28) = "Manual de yoga"
            ComboBox8.Items.Item(0) = "(No)"
            ComboBox8.Items.Item(1) = "Manual de ballet"
            ComboBox8.Items.Item(2) = "Bate de béisbol"
            ComboBox8.Items.Item(3) = "Kit de belleza"
            ComboBox8.Items.Item(4) = "Libro"
            ComboBox8.Items.Item(5) = "Pompas de jabón"
            ComboBox8.Items.Item(6) = "CD"
            ComboBox8.Items.Item(7) = "Teléfono móvil"
            ComboBox8.Items.Item(8) = "Caña de pescar"
            ComboBox8.Items.Item(9) = "Palo de golf"
            ComboBox8.Items.Item(10) = "Guitarra"
            ComboBox8.Items.Item(11) = "Manual de danza hula"
            ComboBox8.Items.Item(12) = "Cometa"
            ComboBox8.Items.Item(13) = "Ordenador portátil"
            ComboBox8.Items.Item(14) = "Maracas"
            ComboBox8.Items.Item(15) = "Detector de metales"
            ComboBox8.Items.Item(16) = "Espejo"
            ComboBox8.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox8.Items.Item(18) = "Saco de boxeo"
            ComboBox8.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox8.Items.Item(20) = "Vale para cuidar perros"
            ComboBox8.Items.Item(21) = "Báscula"
            ComboBox8.Items.Item(22) = "Monopatín"
            ComboBox8.Items.Item(23) = "Balón de fútbol"
            ComboBox8.Items.Item(24) = "Kit de estudio"
            ComboBox8.Items.Item(25) = "Raqueta de tenis"
            ComboBox8.Items.Item(26) = "Cinta de correr"
            ComboBox8.Items.Item(27) = "Wii U"
            ComboBox8.Items.Item(28) = "Manual de yoga"
            ComboBox9.Items.Item(0) = "(No)"
            ComboBox9.Items.Item(1) = "Manual de ballet"
            ComboBox9.Items.Item(2) = "Bate de béisbol"
            ComboBox9.Items.Item(3) = "Kit de belleza"
            ComboBox9.Items.Item(4) = "Libro"
            ComboBox9.Items.Item(5) = "Pompas de jabón"
            ComboBox9.Items.Item(6) = "CD"
            ComboBox9.Items.Item(7) = "Teléfono móvil"
            ComboBox9.Items.Item(8) = "Caña de pescar"
            ComboBox9.Items.Item(9) = "Palo de golf"
            ComboBox9.Items.Item(10) = "Guitarra"
            ComboBox9.Items.Item(11) = "Manual de danza hula"
            ComboBox9.Items.Item(12) = "Cometa"
            ComboBox9.Items.Item(13) = "Ordenador portátil"
            ComboBox9.Items.Item(14) = "Maracas"
            ComboBox9.Items.Item(15) = "Detector de metales"
            ComboBox9.Items.Item(16) = "Espejo"
            ComboBox9.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox9.Items.Item(18) = "Saco de boxeo"
            ComboBox9.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox9.Items.Item(20) = "Vale para cuidar perros"
            ComboBox9.Items.Item(21) = "Báscula"
            ComboBox9.Items.Item(22) = "Monopatín"
            ComboBox9.Items.Item(23) = "Balón de fútbol"
            ComboBox9.Items.Item(24) = "Kit de estudio"
            ComboBox9.Items.Item(25) = "Raqueta de tenis"
            ComboBox9.Items.Item(26) = "Cinta de correr"
            ComboBox9.Items.Item(27) = "Wii U"
            ComboBox9.Items.Item(28) = "Manual de yoga"
            ComboBox10.Items.Item(0) = "(No)"
            ComboBox10.Items.Item(1) = "Manual de ballet"
            ComboBox10.Items.Item(2) = "Bate de béisbol"
            ComboBox10.Items.Item(3) = "Kit de belleza"
            ComboBox10.Items.Item(4) = "Libro"
            ComboBox10.Items.Item(5) = "Pompas de jabón"
            ComboBox10.Items.Item(6) = "CD"
            ComboBox10.Items.Item(7) = "Teléfono móvil"
            ComboBox10.Items.Item(8) = "Caña de pescar"
            ComboBox10.Items.Item(9) = "Palo de golf"
            ComboBox10.Items.Item(10) = "Guitarra"
            ComboBox10.Items.Item(11) = "Manual de danza hula"
            ComboBox10.Items.Item(12) = "Cometa"
            ComboBox10.Items.Item(13) = "Ordenador portátil"
            ComboBox10.Items.Item(14) = "Maracas"
            ComboBox10.Items.Item(15) = "Detector de metales"
            ComboBox10.Items.Item(16) = "Espejo"
            ComboBox10.Items.Item(17) = "Nintendo 3DS XL"
            ComboBox10.Items.Item(18) = "Saco de boxeo"
            ComboBox10.Items.Item(19) = "Vale para cuidar gatos"
            ComboBox10.Items.Item(20) = "Vale para cuidar perros"
            ComboBox10.Items.Item(21) = "Báscula"
            ComboBox10.Items.Item(22) = "Monopatín"
            ComboBox10.Items.Item(23) = "Balón de fútbol"
            ComboBox10.Items.Item(24) = "Kit de estudio"
            ComboBox10.Items.Item(25) = "Raqueta de tenis"
            ComboBox10.Items.Item(26) = "Cinta de correr"
            ComboBox10.Items.Item(27) = "Wii U"
            ComboBox10.Items.Item(28) = "Manual de yoga"
        End If
