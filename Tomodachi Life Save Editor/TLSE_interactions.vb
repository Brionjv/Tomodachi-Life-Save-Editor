...
Public Class TLSE_interactions
    ...
    Public Sub InteractionlistEUR()
        ...
        ElseIf valu_interaction.Value = &H149 Then
            ...
            infobubble_interaction.Visible = True
            infobubble_target1.Visible = True
            Text_infobubble_interaction.Text = "You must select a 'unknow' Mii"
        ...
        ElseIf valu_interaction.Value = &H156 Then
            ...
            infobubble_interaction.Visible = True
            infobubble_target1.Visible = True
            Text_infobubble_interaction.Text = "You must select a 'spouse' Mii / This interaction can cause infinite baby born"
            Text_infobubble_target1.Text = "Must have same interaction, target this Mii / Babies must be enabled in Tomodachi Life"
            Select_target1.Visible = True
            valu_target1.Visible = False
        ElseIf valu_interaction.Value = &H157 Then
            ...
            infobubble_interaction.Visible = True
            infobubble_target1.Visible = True
            Text_infobubble_interaction.Text = "You must select a 'spouse' Mii / This interaction can cause infinite baby grown"
            Text_infobubble_target1.Text = "Must have same interaction, target this Mii / Babies must be enabled in Tomodachi Life"
            Select_target1.Visible = True
            valu_target1.Visible = False
