...
Public Class Miimusic_edit
    ...
    Public Sub readmusic()
        ...
        Catch ex As Exception
            If TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(0) Then
                TLSE_dialog.Text_TLSE_dialog.Text = "Failed to read savedataArc.txt, make sure you have opened a file, or report this issue"
                TLSE_dialog.ShowDialog()
            End If
            If TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(1) Then
                TLSE_dialog.Text_TLSE_dialog.Text = "La lecture de savedataArc.txt a échoué, soyez sûr d'avoir ouvert un fichier, ou signalez cet erreur"
                TLSE_dialog.ShowDialog()
            End If
        End Try
    End Sub
    ...
    Private Sub Text_save_Click(sender As Object, e As EventArgs) Handles Text_save.Click
        ...
        Catch ex As Exception
            If TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(0) Then
                TLSE_dialog.Text_TLSE_dialog.Text = "Failed to write savedataArc.txt, make sure you have opened a file, or report this issue"
                TLSE_dialog.ShowDialog()
            End If
            If TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(1) Then
                TLSE_dialog.Text_TLSE_dialog.Text = "L'écriture de savedataArc.txt a échoué, soyez sûr d'avoir ouvert un fichier, ou signalez cet erreur"
                TLSE_dialog.ShowDialog()
            End If
        End Try
    End Sub
