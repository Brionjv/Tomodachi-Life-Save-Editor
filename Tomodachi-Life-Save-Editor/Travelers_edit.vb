...
Public Class Travelers_edit
    ...
    Public Sub readmiiname()
        Try
            Dim Reader As New PackageIO.Reader(savedataArc, PackageIO.Endian.Little)
            If TL_SaveEditor.Filever_text.Text = "EU" Or TL_SaveEditor.Filever_text.Text = "US" Or TL_SaveEditor.Filever_text.Text = "KR" Then
    ...
    Private Sub Danger_interaction_Click(sender As Object, e As EventArgs) Handles Danger_interaction.Click
        If TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(0) Then
            TLSE_dialog.Text_TLSE_dialog.Text = "You must select a target Mii (target 1)"
            TLSE_dialog.ShowDialog()
        ElseIf TL_SaveEditor.Select_language.SelectedItem = TL_SaveEditor.Select_language.Items.Item(1) Then
            TLSE_dialog.Text_TLSE_dialog.Text = "Vous devez sélectionner un Mii cible (cible 1)"
            TLSE_dialog.ShowDialog()
        End If
    End Sub
End Class