...
Public Class TL_SaveEditor
    ...
    Private Sub Check_resetmiiapart_MouseMove(sender As Object, e As EventArgs) Handles Check_resetmiiapart.MouseMove
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            Text_description.Text = "Set as orange to reset Miis apartment"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(1) Then
            Text_description.Text = "Mettre à l'orange pour réinitialiser l'appartement des Mii"
        End If
        Panel_description.Visible = True
    End Sub
    ...
    Private Sub Icon_TLSE_MouseMove(sender As Object, e As MouseEventArgs) Handles Icon_TLSE.MouseMove
        ...
        If Select_language.SelectedItem = Select_language.Items.Item(0) Then
            Text_description.Text = "Click to access to Tomodachi Life Save Editor page"
        ElseIf Select_language.SelectedItem = Select_language.Items.Item(1) Then
            Text_description.Text = "Cliquez pour accéder à la page de Tomodachi Life Save Editor"
        End If
        Panel_description.Visible = True
    End Sub
